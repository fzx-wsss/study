...
public class Test implements Serializable {
	...
	public static void main(String[] args) throws Exception {
		Enumeration<URL> urls = Test.class.getClassLoader().getResources("META-INF/dubbo/com.wsss.spi.dubbo.Search");
		// Enumeration<URL> urls =
		// Test.class.getClassLoader().getResources("META-INF/dubbo/internal/com.alibaba.dubbo.cache.CacheFactory");
