...
/**
 * TODO: 添加必要的日志打印信息 Kafka Lower consumer api ==> Kafka Simple Consumer API
...
public class JavaKafkaSimpleConsumerAPI {
	...
	private Map<MyKafkaTopicPartitionInfo, List<MyKafkaBrokerInfo>> replicaBrokers = new HashMap<MyKafkaTopicPartitionInfo, List<MyKafkaBrokerInfo>>();
	 ...
	 * @throws Exception
	 */
	public void run(long maxReads, MyKafkaTopicPartitionInfo topicPartitionInfo, List<MyKafkaBrokerInfo> seedBrokers)
			throws Exception {
	 ...
	 * @return
	 */
	public PartitionMetadata findLeader(List<MyKafkaBrokerInfo> brokers, String topic, int partitionID) {
		PartitionMetadata partitionMetadata = null;

		for (MyKafkaBrokerInfo broker : brokers) {
						...
						for (PartitionMetadata part : topicMetadata.partitionsMetadata()) {
							if (part.partitionId() == partitionID) {
								...
								if (partitionMetadata != null) {
									MyKafkaTopicPartitionInfo topicPartitionInfo = new MyKafkaTopicPartitionInfo(topic,
											partitionID);
									List<MyKafkaBrokerInfo> brokerInfos = this.replicaBrokers.get(topicPartitionInfo);
									if (brokerInfos == null) {
										brokerInfos = new ArrayList<MyKafkaBrokerInfo>();
									} else {
										brokerInfos.clear();
									}

									for (Broker replica : partitionMetadata.replicas()) {
										brokerInfos.add(new MyKafkaBrokerInfo(replica.host(), replica.port()));
									}
	 ...
	 * @return
	 */
	public static List<Integer> fetchTopicPartitionIDs(List<MyKafkaBrokerInfo> brokers, String topic, int soTimeout,
