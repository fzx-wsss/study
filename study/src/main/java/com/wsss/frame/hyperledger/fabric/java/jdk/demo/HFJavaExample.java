package com.wsss.frame.hyperledger.fabric.java.jdk.demo;
...
public class HFJavaExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HFCAClient caClient = getHfCaClient("http://39.105.35.145:7054", null);
        ...
        //update
        invokeBlockChain(client, "update", "ACCOUNT1", "jill_2");
    ...
    static Channel getChannel(HFClient client) throws InvalidArgumentException, TransactionException {
        ...
        Peer peer = client.newPeer("peer1", "grpc://39.105.35.145:8051");
        // Peer peer = client.newPeer("peer1", "grpc://39.105.35.145:8051");

        // eventhub name and endpoint in fabcar network
        //EventHub eventHub = client.newEventHub("eventhub01", "grpc://39.105.35.145:7053");
        // orderer name and endpoint in fabcar network
        Orderer orderer = client.newOrderer("orderer", "grpc://39.105.35.145:7050");
