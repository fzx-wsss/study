...
//            URI websocketURI = new URI("wss://fapiws.bittime.com/stream?listenKey=194b85abb15bb642dd3a886c8619e039db29ce9afd8c8e8a2d40bd65b9a7ef17");
...
//                sengPong(channel);
    ...
    public static void sengSub(Channel channel,String symbol) {
        //发送的内容，是一个文本格式的内容
        String putMessage = "{\"event\":\"SUBSCRIBE\",\"id\":\"123\",\"params\":[{\"chain\":\"sol\",\"type\":\"swap\",\"token\":\"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v\",\"scene\":\"detail_real\"}]}";
