...
//            URI websocketURI = new URI("ws://3.0.135.116:12345/etf/ws");
            ...
            final Channel channel = boot.connect(websocketURI.getHost(), 8888).sync().channel();
            //阻塞等待是否握手成功
...
//                sengPong(channel);
    ...
    public static void sengSub(Channel channel,String symbol) {
        //发送的内容，是一个文本格式的内容
//        String putMessage = "{\"event\":\"sub\",\"params\":{\"cb_id\":\""+symbol+"\",\"channel\":\"market_"+symbol+"_simple_depth_step2\",\"top\":20}}";
