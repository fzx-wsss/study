package com.wsss.basic.util.encrypt.desede;
...
public class CipherUtil {
     ...
     * @throws Exception 
     */  
    public static byte[] des3EncodeECB(byte[] key, byte[] data,String algorithm,String mode)  
            throws Exception {  
        Key deskey = null;  
     ...
     * @throws Exception 
     */  
    public static byte[] des3DecodeECB(byte[] key, byte[] data,String algorithm,String mode)  
            throws Exception {  
        Key deskey = null;  
        SecretKeySpec spec = new SecretKeySpec(key,algorithm);   
        SecretKeyFactory keyfactory = SecretKeyFactory.getInstance(algorithm);  
	...
	public static void main(String[] args) throws Exception {
		...
		// 3DES
		byte[] encrypt = encrypt(HexString2Bytes(target), "DESede/ECB/NoPadding","DESede", "080008000944400041424106414043040800080009444000");
		System.out.println("加密后：" + bytesToHexString((encrypt)));
		byte[] decrypt2 = decrypt(HexString2Bytes("8FC3109372A1FDD5"), "DESede/ECB/NoPadding","DESede", "080008000944400041424106414043040800080009444000");
		System.out.println("解密后：" + bytesToHexString(decrypt2));
		 ...
		 */
		 ...
		 byte[] aa = des3EncodeECB(HexString2Bytes("080008000944400041424106414043040800080009444000"), HexString2Bytes("4434413946333539"),"DESede","DESede/ECB/NoPadding");
		 System.out.println("加密后：" + bytesToHexString(aa));
		 byte[] bb = des3DecodeECB(HexString2Bytes("080008000944400041424106414043040800080009444000"), HexString2Bytes("8FC3109372A1FDD5"),"DESede","DESede/ECB/NoPadding");
