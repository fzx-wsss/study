...
public abstract class RsaUtils {
	...
	public static Map<String, String> genKeyPair(int modulus) {
		...
		try {
			...
			keyMaps.put("publicKey", new String(Base64.getEncoder().encode(publicKey.getEncoded())));
			RSAPrivateKey privateKey = (RSAPrivateKey) keyPair.getPrivate();
			keyMaps.put("privateKey", new String(Base64.getEncoder().encode(privateKey.getEncoded())));
