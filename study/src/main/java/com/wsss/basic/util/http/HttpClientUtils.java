...
public final class HttpClientUtils {
	...
	public static <T> T send(final Method method, final String uri, final Map<String, String> headers, final HttpEntity entity,
		...
		builder.setUri(uri);
		if(null != nameValuePairs) builder.addParameters(nameValuePairs.toArray(new NameValuePair[nameValuePairs.size()]));
