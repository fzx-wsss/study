...
public final class HttpClientUtils {
	...
	public static String send(final Method method, final String uri, final Map<String, String> params,
		...
		else config = RequestConfig.custom().setConnectionRequestTimeout(timeout).setConnectTimeout(timeout)
	...
	public static <T> T send(final Method method, final String uri, final Map<String, String> headers,
		...
		// handler = null == handler ? stringResponseHandler : handler;
	...
	public static String send(final Method method, final String url, final Map<String, String> headers,
		...
		if (entity == null) return send(method, url, headers, null, nameValuePairs, useURLEncoder, encodeCharset,
				stringResponseHandler, null);
		else return send(method, url, headers, entity, nameValuePairs, useURLEncoder, encodeCharset,
				stringResponseHandler, null);
	}
